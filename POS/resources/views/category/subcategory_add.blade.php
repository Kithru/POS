        ...
        <table style="width:100%; border-collapse:collapse; margin-top:10px; font-size:14px;">
            <thead>
                <tr style="background:#f5f5f5; text-align:center;">
                    <th style="padding:12px; border-bottom:2px solid #ddd; width:8%;">#</th>
                    <th style="padding:12px; border-bottom:2px solid #ddd; text-align:left; width:12%;">Subcategory Code</th>
                    <th style="padding:12px; border-bottom:2px solid #ddd; text-align:left; width:20%;">Category</th>
                    <th style="padding:12px; border-bottom:2px solid #ddd; text-align:left; width:25%;">Subcategory Name</th>
                    <th style="padding:12px; border-bottom:2px solid #ddd; text-align:left; width:25%;">Description</th>
            ...
            <tbody>
                @forelse($subcategories as $index => $subcategory)
                    <tr style="text-align:center; border-bottom:1px solid #eee;">
                        ...
                        <!-- Subcategory Code -->
                        <td style="padding:12px; text-align:left;">{{ $subcategory->subcategory_code ?? 'N/A' }}</td>
