...
<head>
    ...
    <style>
        ...
        h2 { font-size:18px; color:#2c3e50; border-bottom:1px solid #ddd; padding-bottom:5px; margin-top:20px; }
        p { margin:4px 0; }
    ...
    <div class="container">
        ...
        <div class="section">
            ...
            <p><strong>Address:</strong> 
                {{ $order->customer->street_name }}{{ $order->customer->apartment_no ? ', '.$order->customer->apartment_no : '' }},
                {{ $order->customer->city }}, {{ $order->customer->perfecture }}, {{ $order->customer->postal_code }}
            </p>
        </div>
        ...
        <div class="section">
            ...
            <p><strong>Address:</strong> 
                {{ $order->customer->receiver_street_name }}{{ $order->customer->receiver_apartment_no ? ', '.$order->customer->receiver_apartment_no : '' }},
                {{ $order->customer->receiver_city }}, {{ $order->customer->receiver_prefecture }}, {{ $order->customer->receiver_postal_code }}
            </p>
        </div>
